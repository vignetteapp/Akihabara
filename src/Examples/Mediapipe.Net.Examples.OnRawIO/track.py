...
# | bin/Debug/net5.0/Mediapipe.Net.Examples.OnRawIO $sw $sh mediapipe/graphs/face_mesh/face_mesh_desktop_live.pbtxt \
...
p_track = subprocess.Popen([
    "bin/Debug/net5.0/Mediapipe.Net.Examples.OnRawIO",
