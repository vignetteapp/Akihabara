...
namespace Mediapipe.Net.Tests.Format
{
    ...
    public class ImageFrameTest
    {
        ...
        public void Ctor_ShouldInstantiateImageFrame_When_CalledWithPixelData()
        {
            ...
            byte[] bytes = imageFrame.CopyToByteBuffer(32);
        ...
        public void SetToZero_ShouldSetZeroToAllBytes()
        {
            ...
            byte[] origBytes = imageFrame.CopyToByteBuffer(100);

            imageFrame.SetToZero();
            byte[] bytes = imageFrame.CopyToByteBuffer(100);
        ...
        {
            using var imageFrame = new ImageFrame(ImageFormat.Format.Gray8, 10, 10);
            byte[] normalBuffer = imageFrame.CopyToByteBuffer(100);
            byte[] largeBuffer = imageFrame.CopyToByteBuffer(120);
        ...
        public void CopyToUshortBuffer_ShouldReturnUshortArray_When_BufferSizeIsLargeEnough()
        {
            ...
            ushort[] normalBuffer = imageFrame.CopyToUshortBuffer(100);
            ushort[] largeBuffer = imageFrame.CopyToUshortBuffer(120);
        ...
        public void CopyToFloatBuffer_ShouldReturnFloatArray_When_BufferSizeIsLargeEnough()
        {
            ...
            float[] normalBuffer = imageFrame.CopyToFloatBuffer(100);
            float[] largeBuffer = imageFrame.CopyToFloatBuffer(120);
